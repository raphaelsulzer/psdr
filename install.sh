...
conda install -y anaconda::gmp
conda install -y conda-forge::boost
conda install -y conda-forge::xtensor conda-forge::xtensor-io 
conda install -y conda-forge::xtensor-io 
conda install -y spdlog
conda install -y cgal 
conda install -y anaconda::mpfr 
# cona install -y yaml-cpp 
conda install -y omnia::eigen3
